...
extension TextField {
    ...
    func configCommonBorderView() {
        if self.subviews.contains(commonBorderView) == false, let underline = self.underline {
            ...
            commonBorderView.topAnchor.constraint(equalTo: self.topAnchor, constant: 4.0).isActive = true
            ...
            commonBorderView.bottomAnchor.constraint(equalTo: underline.bottomAnchor, constant: -4.0).isActive = true
            ...
            leadingUnderlineLabel.topAnchor.constraint(equalTo: commonBorderView.bottomAnchor, constant: 3.0).isActive = true
            ...
            trailingUnderlineLabel.topAnchor.constraint(equalTo: commonBorderView.bottomAnchor, constant: 3.0).isActive = true
